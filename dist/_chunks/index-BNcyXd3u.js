...
const StyledPinMap = styled__default.default(icons.PinMap)`
  path {
    fill: ${({ theme }) => theme.colors.primary500};
  }
`;
const PluginIcon = () => /* @__PURE__ */ jsxRuntime.jsx(StyledPinMap, {});
...
const index = {
  register(app) {
    ...
    app.customFields.register({
      ...
      // },
      components: {
        Input: async () => Promise.resolve().then(() => require("./index-DTkrw6a7.js"))
      },
      options: {
        advanced: [
          {
  ...
  async registerTrads(app) {
    ...
    const importedTrads = await Promise.all(
      locales.map((locale) => {
        return __variableDynamicImportRuntimeHelper(/* @__PURE__ */ Object.assign({ "./translations/en.json": () => Promise.resolve().then(() => require("./en-B4KWt_jN.js")), "./translations/fr.json": () => Promise.resolve().then(() => require("./fr-C8Qw4iPZ.js")) }), `./translations/${locale}.json`).then(({ default: data }) => {
          return {
...
//# sourceMappingURL=index-BNcyXd3u.js.map
