...
const L__namespace = /* @__PURE__ */ _interopNamespace(L);
const Chrome__default = /* @__PURE__ */ _interopDefault(Chrome);
const Slider__default = /* @__PURE__ */ _interopDefault(Slider);
const Geoman = ({ geojson, setGeojson }, forwrdedRef) => {
  const ref = React__namespace.useRef(null);
  React__namespace.useImperativeHandle(forwrdedRef, () => {
    return {
      setStyle(options, index) {
        const layers = ref.current?.getLayers();
        if (!layers)
          return;
        if (layers[index] instanceof L__namespace.Marker)
          return;
        const layerId = ref.current?.getLayerId(layers[index]);
        if (!layerId)
          return;
        const layer = ref.current?.getLayer(layerId);
  ...
  React__namespace.useEffect(() => {
    if (ref.current?.getLayers().length === 0 && geojson) {
      L__namespace.geoJSON(geojson).eachLayer((layer) => {
        if (layer instanceof L__namespace.Polyline || layer instanceof L__namespace.Polygon || layer instanceof L__namespace.Marker) {
  ...
  const handleChange = () => {
    ...
    if (layers) {
      layers.forEach((layer) => {
        if (layer instanceof L__namespace.Circle || layer instanceof L__namespace.CircleMarker) {
        ...
        } else if (layer instanceof L__namespace.Marker || layer instanceof L__namespace.Polygon || layer instanceof L__namespace.Rectangle || layer instanceof L__namespace.Polyline) {
          newGeo.features.push({
            ...layer.toGeoJSON(),
            properties: {
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(reactLeaflet.FeatureGroup, { ref, children: /* @__PURE__ */ jsxRuntime.jsx(
    reactLeafletGeomanV2.GeomanControls,
    {
      options: {
        position: "topleft",
        drawText: false,
...
const GeomanWrapper = React__namespace.forwardRef(Geoman);
...
var IntlContext = typeof window !== "undefined" ? window.__REACT_INTL_CONTEXT__ || (window.__REACT_INTL_CONTEXT__ = React__namespace.createContext(null)) : React__namespace.createContext(null);
...
(function(module2, exports2) {
  (function() {
    ...
    var runInContext = function runInContext2(context) {
      ...
      var Array2 = context.Array, Date2 = context.Date, Error2 = context.Error, Function2 = context.Function, Math = context.Math, Object2 = context.Object, RegExp2 = context.RegExp, String = context.String, TypeError = context.TypeError;
...
const StripeSlider = (props) => /* @__PURE__ */ jsxRuntime.jsx(Slider__default.default, { ...props });
const SortableItem = ({
  feature,
  handleChange,
  handleRemove,
  ...
  const [visibleWeight, setVisibeWeight] = React.useState(false);
  const buttonRef = React.useRef(null);
  const weightBtnRef = React.useRef(null);
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(
    designSystem.Flex,
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntime.jsx(designSystem.IconButton, { noBorder: true, icon: /* @__PURE__ */ jsxRuntime.jsx(icons.Drag, {}) }),
        !["Marker"].includes(feature?.properties?.shape) && /* @__PURE__ */ jsxRuntime.jsx(
          designSystem.Button,
          {
            ref: buttonRef,
        ...
        !["Marker"].includes(feature?.properties?.shape) && /* @__PURE__ */ jsxRuntime.jsx(
          designSystem.IconButton,
          {
            ...
            ref: weightBtnRef,
            noBorder: true,
            icon: /* @__PURE__ */ jsxRuntime.jsx(icons.List, {})
          }
        ),
        /* @__PURE__ */ jsxRuntime.jsx(designSystem.Typography, { style: { margin: "0 4px", fontSize: "12px" }, children: feature.geometry.type }),
        ...
        visibleColor && /* @__PURE__ */ jsxRuntime.jsx(
        ...
        visibleWeight && /* @__PURE__ */ jsxRuntime.jsx(
          designSystem.Popover,
          {
            centered: true,
            source: weightBtnRef,
            ...
            children: /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Flex, { gap: "12px", children: [
              ...
              /* @__PURE__ */ jsxRuntime.jsx(
                StripeSlider,
                {
                  ...
                  onChangeComplete: (nr) => handleWeightChange(nr, feature)
                }
              )
            ] })
          }
...
const validateGeoJSON = (geoJSON) => {
  try {
    ...
    const isValid = geojsonValidation.valid(geoJSONObject);
    if (isValid) {
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
    ...
    /* @__PURE__ */ jsxRuntime.jsx(
      designSystem.Button,
      {
        ...
        children: files ? files.name : "Upload GeoJSON..."
      }
    ),
    /* @__PURE__ */ jsxRuntime.jsx("br", {})
  ] });
};
const exportGeoJSON = (data, name) => {
  const jsonString = `data:text/json;chatset=utf-8,${encodeURIComponent(
    JSON.stringify(data)
  )}`;
  const link = document.createElement("a");
  link.href = jsonString;
  link.download = name ? `${name}.json` : `geojson-${(/* @__PURE__ */ new Date()).getMilliseconds()}.json`;
  link.click();
};
const ExportGeoJSON = ({ data, name }) => {
  const handleClick = () => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(
    designSystem.Box,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntime.jsx(UploadGeoJSON, { onUpload: onFeaturesUpload }),
        /* @__PURE__ */ jsxRuntime.jsx(
          reactSortablejs.ReactSortable,
          {
            ...
            setList,
            children: geojson.features.map((feature, i) => /* @__PURE__ */ jsxRuntime.jsx(
              SortableItem,
              {
                feature,
                handleWeightChange,
        ...
        /* @__PURE__ */ jsxRuntime.jsx(ExportGeoJSON, { data: geojson, name: "" })
      ]
    }
  );
};
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
      ...
      designSystem.Flex,
      {
        ...
        children: /* @__PURE__ */ jsxRuntime.jsx(
          designSystem.Button,
          {
            ...
            variant: "tertiary",
            endIcon: /* @__PURE__ */ jsxRuntime.jsx(icons.Expand, {}),
            children: "Expand"
          }
        )
      }
    ...
    isVisible && /* @__PURE__ */ jsxRuntime.jsxs(
      designSystem.ModalLayout,
      {
        ...
        labelledBy: "title",
        children: [
          /* @__PURE__ */ jsxRuntime.jsx(designSystem.ModalHeader, { children: /* @__PURE__ */ jsxRuntime.jsx(
          ...
          /* @__PURE__ */ jsxRuntime.jsx(
            designSystem.ModalFooter,
            {
              endActions: /* @__PURE__ */ jsxRuntime.jsx(
                ...
                {
                  variant: "tertiary",
                  endIcon: /* @__PURE__ */ jsxRuntime.jsx(icons.Collapse, {}),
                  onClick: () => setIsVisible((prev) => !prev),
                  children: "Collapse"
                }
              )
...
const validateConfig = (config) => {
  ...
  return {
    latitude: !isNaN(latitude) ? latitude : void 0,
    longitude: !isNaN(longitude) ? longitude : void 0,
    zoom: !isNaN(zoom) ? zoom : void 0,
    tileUrl,
    tileAttribution,
    tileAccessToken
  };
...
const Input = (props) => {
  ...
  React.useEffect(() => {
    const parsedValue = !!props.value ? JSON.parse(props.value) : null;
    if (!parsedValue)
      return;
    setGeojson(parsedValue);
  }, [props.value]);
  const geomanRef = React.useRef(null);
  const [geojson, setGeojson] = React__namespace.default.useState({
    type: "FeatureCollection",
    features: []
  });
  ...
  const mapProps = {
    ...
    tileAttribution: individualConfig.tileAttribution ?? globalConfig.tileAttribution ?? "",
    tileAccessToken: individualConfig.tileAccessToken ?? globalConfig.tileAccessToken ?? ""
  };
  ...
  const handleColorChange = (color, feature) => {
    const featureIndex = geojson.features.findIndex(
      (ft) => lodashExports.isEqual(ft.geometry, feature.geometry)
    );
    if (featureIndex >= 0) {
  ...
  const handleWeightChange = (weight, feature) => {
    const featureIndex = geojson.features.findIndex(
      (ft) => lodashExports.isEqual(ft, feature)
    );
    if (featureIndex >= 0) {
      const geo = _.cloneDeep(geojson);
      geo.features.splice(featureIndex, 1, {
  ...
  const handleFeatureRemove = (feature) => {
    const newGeoJSON = {
      type: "FeatureCollection",
      features: geojson.features.filter((item) => !lodashExports.isEqual(item, feature))
    };
    const featureIndex = geojson.features.findIndex(
      (ft) => lodashExports.isEqual(ft, feature)
    );
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
    /* @__PURE__ */ jsxRuntime.jsx(designSystem.Typography, { variant: "pi", fontWeight: "bold", children: formatMessage(props.intlLabel) }),
    ...
    !!config && /* @__PURE__ */ jsxRuntime.jsx(ModalWrapper, { children: /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Box, { style: { display: "flex", height: "90vh" }, children: [
      /* @__PURE__ */ jsxRuntime.jsx(designSystem.Box, { style: { width: "calc(100% - 240px)" }, children: /* @__PURE__ */ jsxRuntime.jsxs(reactLeaflet.MapContainer, { zoom: mapProps.zoom, center: mapProps.center, children: [
        /* @__PURE__ */ jsxRuntime.jsx(
...
//# sourceMappingURL=index-DTkrw6a7.js.map
