...
import { Flex, IconButton, Button, Typography, Popover, Box, ModalLayout, ModalHeader, ModalBody, ModalFooter, Loader } from "@strapi/design-system";
import Chrome from "@uiw/react-color-chrome";
import { Drag, List, Trash, Upload, Download, Expand, Collapse } from "@strapi/icons";
import Slider from "rc-slider";
import "rc-slider/assets/index.css";
import { ReactSortable } from "react-sortablejs";
import { valid } from "geojson-validation";
import { u as useConfig } from "./useConfig-BKs95qrT.mjs";
import "./index-CGvp-vx-.mjs";
...
const Geoman = ({ geojson, setGeojson }, forwrdedRef) => {
  ...
  React.useImperativeHandle(forwrdedRef, () => {
    return {
      setStyle(options, index) {
        ...
        if (!layers)
          return;
        if (layers[index] instanceof L.Marker)
          return;
  ...
  const handleChange = () => {
    ...
    if (layers) {
      layers.forEach((layer) => {
        ...
        } else if (layer instanceof L.Marker || layer instanceof L.Polygon || layer instanceof L.Rectangle || layer instanceof L.Polyline) {
          newGeo.features.push({
            ...layer.toGeoJSON(),
            properties: {
  ...
  return /* @__PURE__ */ jsx(FeatureGroup, { ref, children: /* @__PURE__ */ jsx(
    GeomanControls,
    {
      options: {
        position: "topleft",
...
const GeomanWrapper = React.forwardRef(Geoman);
...
var IntlContext = typeof window !== "undefined" ? window.__REACT_INTL_CONTEXT__ || (window.__REACT_INTL_CONTEXT__ = React.createContext(null)) : React.createContext(null);
...
const StripeSlider = (props) => /* @__PURE__ */ jsx(Slider, { ...props });
const SortableItem = ({
  feature,
  handleChange,
  handleRemove,
  ...
  return /* @__PURE__ */ jsxs(
    Flex,
    {
      ...
      children: [
        /* @__PURE__ */ jsx(IconButton, { noBorder: true, icon: /* @__PURE__ */ jsx(Drag, {}) }),
        !["Marker"].includes(feature?.properties?.shape) && /* @__PURE__ */ jsx(
          Button,
          {
            ref: buttonRef,
        ...
        /* @__PURE__ */ jsx(Typography, { style: { margin: "0 4px", fontSize: "12px" }, children: feature.geometry.type }),
        /* @__PURE__ */ jsx(
          IconButton,
          {
            noBorder: true,
        ...
        visibleWeight && /* @__PURE__ */ jsx(
          Popover,
          {
            ...
            children: /* @__PURE__ */ jsxs(Flex, { gap: "12px", children: [
  ...
  return /* @__PURE__ */ jsxs(
    Box,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsx(UploadGeoJSON, { onUpload: onFeaturesUpload }),
        /* @__PURE__ */ jsx(
          ReactSortable,
          {
            style: {
            ...
            setList,
            children: geojson.features.map((feature, i) => /* @__PURE__ */ jsx(
              SortableItem,
              {
                feature,
                handleWeightChange,
        ...
        /* @__PURE__ */ jsx(ExportGeoJSON, { data: geojson, name: "" })
      ]
    }
  );
};
...
const Input = (props) => {
  ...
  const [geojson, setGeojson] = React__default.useState({
    type: "FeatureCollection",
    features: []
  });
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsx(Typography, { variant: "pi", fontWeight: "bold", children: formatMessage(props.intlLabel) }),
    !config && /* @__PURE__ */ jsx("div", { style: { display: "flex", justifyContent: "center" }, children: /* @__PURE__ */ jsx(Loader, { small: true }) }),
    !!config && /* @__PURE__ */ jsx(ModalWrapper, { children: /* @__PURE__ */ jsxs(Box, { style: { display: "flex", height: "90vh" }, children: [
      /* @__PURE__ */ jsx(Box, { style: { width: "calc(100% - 240px)" }, children: /* @__PURE__ */ jsxs(MapContainer, { zoom: mapProps.zoom, center: mapProps.center, children: [
        /* @__PURE__ */ jsx(
          TileLayer,
          {
...
//# sourceMappingURL=index-Bwk3-DTz.mjs.map
